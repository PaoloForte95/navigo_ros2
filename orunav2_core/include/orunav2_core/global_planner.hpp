...
#ifndef ORUNAV2_CORE__GLOBAL_PLANNER_HPP_
#define ORUNAV2_CORE__GLOBAL_PLANNER_HPP_
...
public:
  ...
  virtual orunav2_msgs::msg::Path createPlan(
    const geometry_msgs::msg::PoseStamped & start,
    const geometry_msgs::msg::PoseStamped & goal) = 0;
};
...
#endif  // ORUNAV2_CORE__GLOBAL_PLANNER_HPP_
