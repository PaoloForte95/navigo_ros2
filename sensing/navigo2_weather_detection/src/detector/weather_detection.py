...
#Import srv and msg
from navigo2_msgs.srv import GetWeatherCondition
from navigo2_msgs.msg import WeatherState
...
class WeahterDetectionService(Node):
    ...
    def __init__(self):
        ...
        self.module_path = os.getcwd() + "/src/navigo_ros2/navigation/navigo2_weather_detection"
