...
#ifndef NAVIGO2_HUMAN_DETECTION__HUMAN_DETECTOR_NODE_HPP_
#define NAVIGO2_HUMAN_DETECTION__HUMAN_DETECTOR_NODE_HPP_
...
#include "navigo2_msgs/msg/human_detection.hpp"
#include "nav2_msgs/msg/speed_limit.hpp"

namespace navigo2_human_detection
{
    class HumanDetector : public nav2_util::LifecycleNode
{
    public:
  /**
   * @brief Constructor for the navigo2_human_detection::HumanDetector
   * @param options Additional options to control creation of the node.
   */
  explicit HumanDetector(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for the navigo2_human_detection::HumanDetector
   */
  ~HumanDetector();
 ...
 /**
   ...
   */
  void dataCallback(navigo2_msgs::msg::HumanDetection msg);
...
rclcpp::Subscription<navigo2_msgs::msg::HumanDetection>::SharedPtr data_sub_;
rclcpp_lifecycle::LifecyclePublisher<nav2_msgs::msg::SpeedLimit>::SharedPtr speed_limit_pub_;
/// @brief Whether main routine is active
bool process_active_;

navigo2_msgs::msg::HumanDetection human_detection_;
