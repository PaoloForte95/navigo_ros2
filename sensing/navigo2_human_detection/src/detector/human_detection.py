...
from navigo2_msgs.msg import HumanDetection as HDMsg
...
class HumanDetectionRos(Node):
    def __init__(self):
        ...
        self.declare_parameter("module_path", "src/navigo_ros2/sensing/navigo2_human_detection/src/detector/humandet.onnx")
