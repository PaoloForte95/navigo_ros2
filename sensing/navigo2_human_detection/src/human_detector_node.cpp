...
#include "navigo2_human_detection/human_detector_node.hpp"
...

{
    ...
    data_sub_ = node->create_subscription<navigo2_msgs::msg::HumanDetection>(topic, scan_qos,std::bind(&HumanDetector::dataCallback, this, std::placeholders::_1));
...
void HumanDetector::dataCallback(navigo2_msgs::msg::HumanDetection msg)
{
