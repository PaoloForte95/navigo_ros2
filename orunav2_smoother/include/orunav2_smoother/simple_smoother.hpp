...
#ifndef ORUNAV2_SMOOTHER__SIMPLE_SMOOTHER_HPP_
#define ORUNAV2_SMOOTHER__SIMPLE_SMOOTHER_HPP_
...
#include "orunav2_core/smoother.hpp"
#include "orunav2_smoother/smoother_utils.hpp"
...
namespace orunav2_smoother
{

/**
 * @class orunav2_smoother::SimpleSmoother
 * @brief A path smoother implementation
 */
class SimpleSmoother : public orunav2_core::Smoother
{
public:
  /**
   * @brief A constructor for orunav2_smoother::SimpleSmoother
   */
  SimpleSmoother() = default;

  /**
   * @brief A destructor for orunav2_smoother::SimpleSmoother
   */
...
#endif  // ORUNAV2_SMOOTHER__SIMPLE_SMOOTHER_HPP_
