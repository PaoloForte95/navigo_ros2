...
#ifndef ORUNAV2_SMOOTHER__NAV2_SMOOTHER_HPP_
#define ORUNAV2_SMOOTHER__NAV2_SMOOTHER_HPP_
...
#include "orunav2_msgs/action/smooth_path.hpp"
...
{
public:
  using SmootherMap = std::unordered_map<std::string, orunav2_core::Smoother::Ptr>;

  /**
   * @brief A constructor for orunav2_smoother::SmootherServer
...
protected:
  ...
  using Action = orunav2_msgs::action::SmoothPath;
...
#endif  // ORUNAV2_SMOOTHER__NAV2_SMOOTHER_HPP_
