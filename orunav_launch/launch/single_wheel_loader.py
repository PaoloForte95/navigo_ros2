...
def generate_launch_description():
    ...
    param_dir = get_package_share_directory('wheel_loader_launch')
    ...
    maps_dir = get_package_share_directory('orunav_maps')
    ...
    declare_robot1_params_file_cmd = DeclareLaunchArgument(
        'robot1_params_file',
        default_value=os.path.join(param_dir, 'params', 'L70_navigation_configs.yaml'),
        description='Full path to the ROS2 parameters file to use for robot1 launched nodes')

    machine_urdf=os.path.join(description_dir, 'urdf', 'L70.urdf')
