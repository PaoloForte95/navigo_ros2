...
#ifndef NAVTHON_CONTROLLER__CONTROLLER_SERVER_HPP_
#define NAVTHON_CONTROLLER__CONTROLLER_SERVER_HPP_
...
/**
 * @class navthon::controller::ControllerServer
...
public:
  ...
  /**
   * @brief Constructor for navthon::controller::ControllerServer
   * @param options Additional options to control creation of the node.
   */
  explicit ControllerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for navthon::controller::ControllerServer
   */
  ~ControllerServer();
