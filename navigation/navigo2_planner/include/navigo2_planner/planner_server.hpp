...
#ifndef NAVIGO2_PLANNER__PLANNER_SERVER_HPP_
#define NAVIGO2_PLANNER__PLANNER_SERVER_HPP_
...
/**
 * @class navigo2_planner::PlannerServer
...
public:
  /**
   * @brief A constructor for navigo2_planner::PlannerServer
   * @param options Additional options to control creation of the node.
   */
  explicit PlannerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for navigo2_planner::PlannerServer
   */
  ~PlannerServer();
...
#endif  // NAVIGO2_PLANNER__PLANNER_SERVER_HPP_
