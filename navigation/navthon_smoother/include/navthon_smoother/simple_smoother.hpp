...
#ifndef NAVTHON_SMOOTHER__SIMPLE_SMOOTHER_HPP_
#define NAVTHON_SMOOTHER__SIMPLE_SMOOTHER_HPP_
...
#include "navthon_smoother/smoother_utils.hpp"
...
/**
 * @class navthon_smoother::SimpleSmoother
 * @brief A path smoother implementation
 */
class SimpleSmoother : public navthon_core::Smoother
{
public:
  /**
   * @brief A constructor for navthon_smoother::SimpleSmoother
   */
  SimpleSmoother() = default;

  /**
   * @brief A destructor for navthon_smoother::SimpleSmoother
   */
...
#endif  // NAVTHON_SMOOTHER__SIMPLE_SMOOTHER_HPP_
