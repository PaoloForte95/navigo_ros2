...
#ifndef NAVTHON_SMOOTHER__NAV2_SMOOTHER_HPP_
#define NAVTHON_SMOOTHER__NAV2_SMOOTHER_HPP_
...
#include "navthon_core/smoother.hpp"
#include "nav2_costmap_2d/costmap_2d_ros.hpp"
#include "nav2_costmap_2d/costmap_subscriber.hpp"
#include "nav2_costmap_2d/costmap_topic_collision_checker.hpp"
#include "nav2_costmap_2d/footprint_subscriber.hpp"
#include "navthon_msgs/action/smooth_path.hpp"
...
namespace navthon_smoother
{

/**
 * @class navthon_smoother::SmootherEclServer
...
{
public:
  using SmootherMap = std::unordered_map<std::string, navthon_core::Smoother::Ptr>;

  /**
   * @brief A constructor for navthon_smoother::SmootherServer
   * @param options Additional options to control creation of the node.
   */
  explicit SmootherServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for navthon_smoother::SmootherServer
   */
  ~SmootherServer();
...
protected:
  ...
  using Action = navthon_msgs::action::SmoothPath;
  ...
  // Smoother Plugins
  pluginlib::ClassLoader<navthon_core::Smoother> lp_loader_;
...
#endif  // NAVTHON_SMOOTHER__NAV2_SMOOTHER_HPP_
