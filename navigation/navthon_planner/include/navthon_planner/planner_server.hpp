...
#ifndef NAVTHON_PLANNER__PLANNER_SERVER_HPP_
#define NAVTHON_PLANNER__PLANNER_SERVER_HPP_
...
namespace navthon_planner
{

/**
 * @class navthon_planner::PlannerServer
...
public:
  /**
   * @brief A constructor for navthon_planner::PlannerServer
   * @param options Additional options to control creation of the node.
   */
  explicit PlannerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for navthon_planner::PlannerServer
   */
  ~PlannerServer();
...
#endif  // NAVTHON_PLANNER__PLANNER_SERVER_HPP_
