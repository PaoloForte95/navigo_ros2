...
#ifndef NAVIGO2_UTIL__CONVERSION_UTILS_HPP_
#define NAVIGO2_UTIL__CONVERSION_UTILS_HPP_
...
namespace conversion_utils
{
  ...
  nav_msgs::msg::Path createPathMsgFromPathInterface(const navigo2_generic::PathInterface &path)
  {
    nav_msgs::msg::Path p;
