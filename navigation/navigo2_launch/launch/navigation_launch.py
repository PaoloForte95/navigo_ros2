...
def generate_launch_description():
    ...
    declare_controller_prefix_cmd = DeclareLaunchArgument(
            'controller_prefix', default_value='',
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            Node(
                ...
                remappings=remappings + [('cmd_vel', cmd_vel_string)]),
            Node(
    ...
    load_composable_nodes = LoadComposableNodes(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                package='navigo2_selector',
                plugin='navigo2_selector::PlannerSelectorServer',
                name='selector_server',
                parameters=[configured_params],
                remappings=remappings),
            ComposableNode(
