...
#ifndef NAVTHON_SELECTOR__COSTMAP_SELECTOR
#define NAVTHON_SELECTOR__COSTMAP_SELECTOR
...
class CostmapSelector : public navthon_core::GlobalPlannerSelector
{
public:
  /**
   * @brief constructor
...
#endif  // NAVTHON_SELECTOR__COSTMAP_SELECTOR
