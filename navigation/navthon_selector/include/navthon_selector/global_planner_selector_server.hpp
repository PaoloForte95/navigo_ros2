...
#ifndef NAVTHON_SELECTOR__GLOBAL_PLANNER_SELECTOR_SERVER_HPP_
#define NAVTHON_SELECTOR__GLOBAL_PLANNER_SELECTOR_SERVER_HPP_
...
#include "navthon_msgs/action/global_planner_selector.hpp"
...
#include "navthon_core/global_planner_selector.hpp"
#include "navthon_msgs/srv/is_planner_valid.hpp"

namespace navthon_selector
{
/**
 * @class navthon_selector::PlannerSelectorServer
...
public:
  /**
   * @brief A constructor for navthon_selector::PlannerSelectorServer
   * @param options Additional options to control creation of the node.
   */
  explicit PlannerSelectorServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for navthon_selector::PlannerSelectorServer
   */
  ~PlannerSelectorServer();

  using PlannerMap = std::unordered_map<std::string, navthon_core::GlobalPlannerSelector::Ptr>;
...
protected:
  ...
  using ActionSelect = navthon_msgs::action::GlobalPlannerSelector;
   ...
   */
  void isPlannerValid(
    const std::shared_ptr<navthon_msgs::srv::IsPlannerValid::Request> request,
    std::shared_ptr<navthon_msgs::srv::IsPlannerValid::Response> response);
  ...
  pluginlib::ClassLoader<navthon_core::GlobalPlannerSelector> gp_loader_;
  ...
  rclcpp::Service<navthon_msgs::srv::IsPlannerValid>::SharedPtr is_planner_valid_service_;
...
#endif  // NAVTHON_SELECTOR__GLOBAL_PLANNER_SELECTOR_SERVER_HPP_
