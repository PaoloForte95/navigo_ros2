#include <navthon_generic/serialization.hpp>
#include <navthon_generic/io.hpp>
#include <fstream>
#include <iostream>
#include <ctime>
...
int main()
{
    ...
    {
        navthon_generic::Control c1(0.1, 0.2);
        navthon_generic::Control c2(0.3, 0.4);
        navthon_generic::Pose2d p(1., 2., 3.);
        ...
        // Load
        navthon_generic::Control c1_restored, c2_restored;
        navthon_generic::Pose2d p_restored;
        {
    ...
    }
    {
        ...
        navthon_generic::Path path = navthon_generic::loadPathTextFile(txt_file_name.c_str());
        ...
        navthon_generic::Pose2dVec pvec(path);
        {
        ...
        // Load
        navthon_generic::Pose2dVec pvec_restored;
        {
        ...
        // Load
        navthon_generic::Path path_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
    ...
    {
        navthon_generic::CoordinatedTimes ct(10);
        ct[0] = 10.;
        ...
        // Load
        navthon_generic::CoordinatedTimes ct_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
...

    {
        ...
        // Load
        navthon_generic::Point2dVec pv_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
