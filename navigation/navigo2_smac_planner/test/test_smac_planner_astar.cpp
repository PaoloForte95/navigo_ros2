...
#include "navigo2_smac_planner/smac_planner_astar.hpp"
...
class LatticeWrap : public navigo2_smac_planner::SmacPlannerAStar
{
public:
...
TEST(SmacTest, test_smac_planner_astar)
{
  ...
  auto planner = std::make_unique<navigo2_smac_planner::SmacPlannerAStar>();
