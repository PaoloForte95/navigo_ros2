...
#include <navigo2_smac_planner/smac_planner_hybrid.hpp>
  ...
  std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
{
  ...
  //Create the planner
  navigo::SearchParams search_params;
  navigo::PlannerParams planner_params;
...
PLUGINLIB_EXPORT_CLASS(navigo2_smac_planner::SmacPlannerHybrid, nav2_core::GlobalPlanner)
