...
#include "navthon_smac_planner/vehicle_mission.hpp"

#include "navthon_smac_planner/model/unicycle_model.hpp"
#include "navthon_smac_planner/model/car_model.hpp"
#include "navthon_smac_planner/model/lhd_model.hpp"
#include "navthon_smac_planner/configuration/car_configuration.hpp"
#include "navthon_smac_planner/configuration/lhd_configuration.hpp"
#include "navthon_smac_planner/configuration/unicycle_configuration.hpp"
...
VehicleMission::VehicleMission(VehicleModel* m, double start_x, double start_y, double start_o, double start_steering,
	...
	} else if (dynamic_cast<navthon_smac_planner::LHDModel*> (m)) {
