...
#ifndef NAVTHON_SMAC_PLANNER__SMAC_PLANNER_HYBRID_HPP_
#define NAVTHON_SMAC_PLANNER__SMAC_PLANNER_HYBRID_HPP_
...
protected:
  ...
  navigatio::CarPlanner* planner_;
  navigatio::Footprint robot_footprint_;
};
