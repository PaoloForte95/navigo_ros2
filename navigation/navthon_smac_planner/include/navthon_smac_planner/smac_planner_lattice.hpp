...
#ifndef NAVTHON_SMAC_PLANNER_LATTICE_PLANNER_H
#define NAVTHON_SMAC_PLANNER_LATTICE_PLANNER_H
...
//ecceleron
#include <navigatio/planner/collision_checker.h>
#include <navigatio/planner/collision_detector.h>
#include <navigatio/planner/lattice/smac_planner_lattice.h>
...
protected:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("PlannerLattice")};
  ...
  navigatio::SmacLatticePlanner* planner_;
