/**
 * @file collision_detector_interface.hpp
 * @author Paolo Forte
 *
 */

#ifndef COLLISIONDETECTORINTERFACE_HPP_
#define COLLISIONDETECTORINTERFACE_HPP_
...
#endif /* COLLISIONDETECTORINTERFACE_HPP_ */
