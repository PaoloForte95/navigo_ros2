...
#ifndef NAVTHON_SMAC_PLANNER__SMOOTHER_HPP_
#define NAVTHON_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @class navthon_smac_planner::PathSegment
...
/**
 * @struct navthon_smac_planner::BoundaryPoints
...
/**
 * @struct navthon_smac_planner::BoundaryExpansion
...
/**
 * @class navthon_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for navthon_smac_planner::Smoother
   */
  explicit Smoother(const nav2_smac_planner::SmootherParams & params);

  /**
   * @brief A destructor for navthon_smac_planner::Smoother
   */
  ~Smoother() {}
...
#endif  // NAVTHON_SMAC_PLANNER__SMOOTHER_HPP_
