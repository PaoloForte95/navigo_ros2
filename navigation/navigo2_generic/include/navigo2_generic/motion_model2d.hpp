...
#include <navigo2_generic/pose2d.hpp>
...
public:
  ...
  navigo2_generic::Pose2dCov getPose2dCov(const navigo2_generic::Pose2d &rel) const
  {
    Pose2dCov ret;
    ret.mean = rel;
  ...
  Eigen::MatrixXd getCovMatrix6(const navigo2_generic::Pose2d &rel) const
  {
...
namespace boost {
  namespace serialization {
    ...
    void serialize(Archive& ar, navigo2_generic::MotionModel2d::Params& o, const unsigned int version) {
      ar & o.Cd
        & o.Ct
        & o.Dd
        & o.Dt
