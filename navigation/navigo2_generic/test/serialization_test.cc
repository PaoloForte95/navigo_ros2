#include <navigo2_generic/serialization.hpp>
#include <navigo2_generic/io.hpp>
#include <fstream>
#include <iostream>
#include <ctime>
...
int main()
{
    ...
    {
        navigo2_generic::Control c1(0.1, 0.2);
        navigo2_generic::Control c2(0.3, 0.4);
        navigo2_generic::Pose2d p(1., 2., 3.);
        ...
        // Load
        navigo2_generic::Control c1_restored, c2_restored;
        navigo2_generic::Pose2d p_restored;
        {
    ...
    }
    {
        ...
        navigo2_generic::Path path = navigo2_generic::loadPathTextFile(txt_file_name.c_str());
        ...
        navigo2_generic::Pose2dVec pvec(path);
        {
        ...
        // Load
        navigo2_generic::Pose2dVec pvec_restored;
        {
        ...
        // Load
        navigo2_generic::Path path_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
    ...
    {
        navigo2_generic::CoordinatedTimes ct(10);
        ct[0] = 10.;
        ...
        // Load
        navigo2_generic::CoordinatedTimes ct_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
...

    {
        ...
        // Load
        navigo2_generic::Point2dVec pv_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
