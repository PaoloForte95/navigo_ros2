...
#include "navthon_behavior_tree/plugins/action/global_planner_selector_node.hpp"
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navthon::behavior_tree::SelectGlobalPlannerAction>(
        name, "select_global_planner", config);
    };

  factory.registerBuilder<navthon::behavior_tree::SelectGlobalPlannerAction>(
