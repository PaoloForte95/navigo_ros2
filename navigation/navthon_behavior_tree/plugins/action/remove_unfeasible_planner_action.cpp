...
#include "navthon_behavior_tree/plugins/action/remove_unfeasible_planner_action.hpp"
...
{
  factory.registerNodeType<navthon::behavior_tree::RemoveUnfeasiblePlanner>("RemoveUnfeasiblePlanner");
}
