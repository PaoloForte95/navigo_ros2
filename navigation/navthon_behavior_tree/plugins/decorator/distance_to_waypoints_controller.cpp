...
#include "navthon_behavior_tree/plugins/decorator/distance_to_waypoints_controller.hpp"
...
{
  factory.registerNodeType<navthon::behavior_tree::DistanceToWaypointsController>("DistanceToWaypointsController");
}
