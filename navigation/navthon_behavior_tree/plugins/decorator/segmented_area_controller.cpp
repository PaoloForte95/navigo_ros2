...
#include "navthon_behavior_tree/plugins/decorator/segmented_area_controller.hpp"
...
{
  factory.registerNodeType<navthon::behavior_tree::SegmentedAreaController>("SegmentedAreaController");
}
