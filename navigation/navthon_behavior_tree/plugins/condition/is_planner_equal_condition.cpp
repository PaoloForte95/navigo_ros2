...
#include "navthon_behavior_tree/plugins/condition/is_planner_equal_condition.hpp"
#include <chrono>
#include <memory>
#include <string>
...
{
  factory.registerNodeType<navthon::behavior_tree::IsPlannerEqualCondition>("IsPlannerEqual");
}
