...
#ifndef NAVTHON_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
#define NAVTHON_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
...
public:
   ...
   * @return navthon::behavior_tree::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
