...
#ifndef NAVTHON_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
#define NAVTHON_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
...
public:
  /**
   * @brief A constructor for navthon::behavior_tree::RosTopicLogger
