...
#ifndef NAVTHON_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
#define NAVTHON_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
...
public:
  /**
   * @brief A navthon::behavior_tree::BtActionNode constructor
...
#endif  // NAVTHON_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
