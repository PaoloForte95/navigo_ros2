...
#ifndef NAVTHON_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
#define NAVTHON_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
...
#include "navthon_behavior_tree/behavior_tree_engine.hpp"
#include "navthon_behavior_tree/ros_topic_logger.hpp"
...
/**
 * @class navthon::behavior_tree::BtActionServer
...
public:
  ...
  typedef std::function<void (typename ActionT::Result::SharedPtr,
      navthon::behavior_tree::BtStatus)> OnCompletionCallback;

  /**
   * @brief A constructor for navthon::behavior_tree::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for navthon::behavior_tree::BtActionServer class
   */
  ~BtActionServer();
...
#include <navthon_behavior_tree/bt_action_server_impl.hpp>  // NOLINT(build/include_order)
#endif  // NAVTHON_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
