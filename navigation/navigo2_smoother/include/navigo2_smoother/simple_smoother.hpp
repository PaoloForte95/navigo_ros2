...
#ifndef NAVIGO2_SMOOTHER__SIMPLE_SMOOTHER_HPP_
#define NAVIGO2_SMOOTHER__SIMPLE_SMOOTHER_HPP_
...
#include "navigo2_smoother/smoother_utils.hpp"
...
namespace navigo2_smoother
{

/**
 * @class navigo2_smoother::SimpleSmoother
 * @brief A path smoother implementation
 */
class SimpleSmoother : public navigo2_core::Smoother
{
public:
  /**
   * @brief A constructor for navigo2_smoother::SimpleSmoother
   */
  SimpleSmoother() = default;

  /**
   * @brief A destructor for navigo2_smoother::SimpleSmoother
   */
...
#endif  // NAVIGO2_SMOOTHER__SIMPLE_SMOOTHER_HPP_
