...
#ifndef NAVIGO2_SELECTOR__GLOBAL_PLANNER_SELECTOR_SERVER_HPP_
#define NAVIGO2_SELECTOR__GLOBAL_PLANNER_SELECTOR_SERVER_HPP_
...
#include "navigo2_msgs/srv/is_planner_valid.hpp"

namespace navigo2_selector
{
/**
 * @class navigo2_selector::PlannerSelectorServer
...
public:
  /**
   * @brief A constructor for navigo2_selector::PlannerSelectorServer
   * @param options Additional options to control creation of the node.
   */
  explicit PlannerSelectorServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for navigo2_selector::PlannerSelectorServer
   */
  ~PlannerSelectorServer();

  using PlannerMap = std::unordered_map<std::string, navigo2_core::GlobalPlannerSelector::Ptr>;
...
protected:
  ...
  using ActionSelect = navigo2_msgs::action::GlobalPlannerSelector;
   ...
   */
  void isPlannerValid(
    const std::shared_ptr<navigo2_msgs::srv::IsPlannerValid::Request> request,
    std::shared_ptr<navigo2_msgs::srv::IsPlannerValid::Response> response);
  ...
  pluginlib::ClassLoader<navigo2_core::GlobalPlannerSelector> gp_loader_;
  ...
  rclcpp::Service<navigo2_msgs::srv::IsPlannerValid>::SharedPtr is_planner_valid_service_;
...
#endif  // NAVIGO2_SELECTOR__GLOBAL_PLANNER_SELECTOR_SERVER_HPP_
