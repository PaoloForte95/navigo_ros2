...
#include "navigo2_behavior_tree/plugins/action/remove_unfeasible_planner_action.hpp"
...
{
  factory.registerNodeType<navigo2::behavior_tree::RemoveUnfeasiblePlanner>("RemoveUnfeasiblePlanner");
}
