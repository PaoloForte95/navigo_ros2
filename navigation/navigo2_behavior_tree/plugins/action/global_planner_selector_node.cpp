...
#include "navigo2_behavior_tree/plugins/action/global_planner_selector_node.hpp"
...
: BtActionNode<navigo2_msgs::action::GlobalPlannerSelector>(xml_tag_name, action_name, conf)
{
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<navigo2::behavior_tree::SelectGlobalPlannerAction>(
        name, "select_global_planner", config);
    };

  factory.registerBuilder<navigo2::behavior_tree::SelectGlobalPlannerAction>(
