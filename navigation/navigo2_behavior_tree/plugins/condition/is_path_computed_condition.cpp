...
#include "navigo2_behavior_tree/plugins/condition/is_path_computed_condition.hpp"
#include <chrono>
#include <memory>
#include <string>
...
{
  factory.registerNodeType<navigo2::behavior_tree::IsPathComputedCondition>("IsPathComputedCondition");
}
