...
#include "navigo2_behavior_tree/plugins/condition/is_planner_updated_condition.hpp"
...
{
  factory.registerNodeType<navigo2::behavior_tree::PlannerUpdatedCondition>("IsPlannerUpdated");
}
