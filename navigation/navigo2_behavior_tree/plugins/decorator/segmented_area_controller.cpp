...
#include "navigo2_behavior_tree/plugins/decorator/segmented_area_controller.hpp"
...
{
  factory.registerNodeType<navigo2::behavior_tree::SegmentedAreaController>("SegmentedAreaController");
}
