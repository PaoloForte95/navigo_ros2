...
#include "navigo2_behavior_tree/plugins/decorator/distance_to_waypoints_controller.hpp"
...
{
  factory.registerNodeType<navigo2::behavior_tree::DistanceToWaypointsController>("DistanceToWaypointsController");
}
