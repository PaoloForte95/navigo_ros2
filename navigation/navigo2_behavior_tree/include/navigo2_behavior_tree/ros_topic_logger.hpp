...
#ifndef NAVIGO2_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
#define NAVIGO2_BEHAVIOR_TREE__ROS_TOPIC_LOGGER_HPP_
...
public:
  /**
   * @brief A constructor for navigo2::behavior_tree::RosTopicLogger
