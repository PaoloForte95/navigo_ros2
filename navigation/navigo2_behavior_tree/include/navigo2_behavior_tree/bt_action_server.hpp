...
#ifndef NAVIGO2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
#define NAVIGO2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
...
#include "navigo2_behavior_tree/behavior_tree_engine.hpp"
#include "navigo2_behavior_tree/ros_topic_logger.hpp"
...
/**
 * @class navigo2::behavior_tree::BtActionServer
...
public:
  ...
  typedef std::function<void (typename ActionT::Result::SharedPtr,
      navigo2::behavior_tree::BtStatus)> OnCompletionCallback;

  /**
   * @brief A constructor for navigo2::behavior_tree::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for navigo2::behavior_tree::BtActionServer class
   */
  ~BtActionServer();
...
#include <navigo2_behavior_tree/bt_action_server_impl.hpp>  // NOLINT(build/include_order)
#endif  // NAVIGO2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
