...
#ifndef NAVIGO2_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
#define NAVIGO2_BEHAVIOR_TREE__BEHAVIOR_TREE_ENGINE_HPP_
...
public:
   ...
   * @return navigo2::behavior_tree::BtStatus Status of BT execution
   */
  BtStatus run(
    BT::Tree * tree,
