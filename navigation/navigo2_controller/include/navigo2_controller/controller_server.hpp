...
#ifndef NAVIGO2_CONTROLLER__CONTROLLER_SERVER_HPP_
#define NAVIGO2_CONTROLLER__CONTROLLER_SERVER_HPP_
...
/**
 * @class navigo2::controller::ControllerServer
...
public:
  ...
  /**
   * @brief Constructor for navigo2::controller::ControllerServer
   * @param options Additional options to control creation of the node.
   */
  explicit ControllerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for navigo2::controller::ControllerServer
   */
  ~ControllerServer();
