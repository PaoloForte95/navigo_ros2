...
namespace orunav_geometry {
  ...
  public:
     ...
     */
    virtual const Polygon& getBoundingRegion(const orunav2_generic::RobotInternalState2d &s) const = 0;
  };
  ...
  public:
    ...
    virtual const Polygon& getBoundingRegion(const orunav2_generic::RobotInternalState2d &s) const {
      switch (s.loadType) {
      case orunav2_generic::RobotInternalState2d::NO_LOAD: 
	return wo_load;
	break;
      case orunav2_generic::RobotInternalState2d::EUR_PALLET:
	// TODO!!!!
	return w_load;
	break;
      case orunav2_generic::RobotInternalState2d::HALF_PALLET:
	// TODO!!!!
	return w_load2;
	break;
      default:
  ...
  /**
   * Model of the volvo wheel loader BM L70
   */

  class RobotModel2dL70 : public RobotModel2dInterface {
  public:
	  RobotModel2dL70() {
       bound.points.push_back(Eigen::Vector2d(3.2, 1.16)); //fl
       bound.points.push_back(Eigen::Vector2d(3.2, -1.16)); //fr
       bound.points.push_back(Eigen::Vector2d(-3.2, -1.16)); //rr
       bound.points.push_back(Eigen::Vector2d(-3.2, 1.16)); //rl
     }
     virtual const Polygon& getBoundingRegion(const orunav2_generic::RobotInternalState2d &s) const {
       // Hardcoded values only - this really is only a square
       return bound;
...
//      bound.points.push_back(Eigen::Vector2d(-0.165, 0.25));
  ...
  class RobotModel2dWithState : public orunav2_generic::Point2dContainerInterface, public orunav2_generic::Point2dCollisionCheckInterface {
  public:
    ...
    void update(const orunav2_generic::Pose2d &p, const orunav2_generic::RobotInternalState2d &is);
    const Polygon& getPosePolygon() const { return posePolygon; }
    const orunav2_generic::Pose2d& getRobotPose() const { return robotPose; }
  ...
  private:
    ...
    Polygon posePolygon;
    orunav2_generic::Pose2d robotPose;
  };
