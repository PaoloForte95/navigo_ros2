...
namespace orunav_geometry {
  ...
  class Polygon : public orunav2_generic::Point2dContainerInterface, orunav2_generic::Point2dCollisionCheckInterface  {
  public:
    Polygon();
    ...
    Polygon getMovedPolygon(const orunav2_generic::Pose2d &pose) const {
      return Polygon(getMovedPoint2dContainer(*this, pose));
    }

    orunav2_generic::Point2dVec points;
  /* private: */
