...
#ifndef ORUNAV2_CONTROLLER__CONTROLLER_SERVER_HPP_
#define ORUNAV2_CONTROLLER__CONTROLLER_SERVER_HPP_
...
/**
 * @class orunav2_controller::ControllerServer
...
public:
  ...
  /**
   * @brief Constructor for orunav2_controller::ControllerServer
   * @param options Additional options to control creation of the node.
   */
  explicit ControllerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for orunav2_controller::ControllerServer
   */
  ~ControllerServer();
...
#endif  // ORUNAV2_CONTROLLER__CONTROLLER_SERVER_HPP_
