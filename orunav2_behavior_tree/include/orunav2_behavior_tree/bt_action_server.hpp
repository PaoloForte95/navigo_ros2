...
#ifndef ORUNAV2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
#define ORUNAV2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
...
#include "orunav2_behavior_tree/behavior_tree_engine.hpp"
#include "orunav2_behavior_tree/ros_topic_logger.hpp"
...
{
/**
 * @class orunav2_behavior_tree::BtActionServer
...
public:
  ...
  typedef std::function<void (typename ActionT::Result::SharedPtr,
      orunav2_behavior_tree::BtStatus)> OnCompletionCallback;

  /**
   * @brief A constructor for orunav2_behavior_tree::BtActionServer class
   */
  ...
  /**
   * @brief A destructor for orunav2_behavior_tree::BtActionServer class
   */
  ~BtActionServer();
...
#include <orunav2_behavior_tree/bt_action_server_impl.hpp>  // NOLINT(build/include_order)
#endif  // ORUNAV2_BEHAVIOR_TREE__BT_ACTION_SERVER_HPP_
