...
#ifndef ORUNAV2_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
#define ORUNAV2_BEHAVIOR_TREE__BT_ACTION_NODE_HPP_
...
public:
  /**
   * @brief A orunav2_behavior_tree::BtActionNode constructor
