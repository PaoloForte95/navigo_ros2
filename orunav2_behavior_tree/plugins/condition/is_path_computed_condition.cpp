...
#include "orunav2_behavior_tree/plugins/condition/is_path_computed_condition.hpp"
#include <chrono>
#include <memory>
#include <string>
...
{
  factory.registerNodeType<orunav2_behavior_tree::IsPathComputedCondition>("IsPathComputedCondition");
}
