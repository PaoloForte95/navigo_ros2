...
#include "orunav2_behavior_tree/plugins/action/navigate_to_pose_action.hpp"
...
: BtActionNode<orunav2_msgs::action::NavigateToPose>(xml_tag_name, action_name, conf)
{
}
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<orunav2_behavior_tree::NavigateToPoseAction>(
        name, "ecl_navigate_to_pose", config);
    };

  factory.registerBuilder<orunav2_behavior_tree::NavigateToPoseAction>(
