...
#include "orunav2_behavior_tree/plugins/action/follow_path_action.hpp"
...
: BtActionNode<orunav2_msgs::action::FollowPath>(xml_tag_name, action_name, conf)
{
}
...
void FollowPathAction::on_wait_for_result(
  std::shared_ptr<const orunav2_msgs::action::FollowPath::Feedback>/*feedback*/)
{
  // Grab the new path
  orunav2_msgs::msg::Path new_path;
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<orunav2_behavior_tree::FollowPathAction>(
        name, "follow_path", config);
    };

  factory.registerBuilder<orunav2_behavior_tree::FollowPathAction>(
    "FollowPath", builder);
}
