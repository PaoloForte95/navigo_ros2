...
int main(int argc, char **argv)
{
  ...
  auto nh_ = rclcpp::Node::make_shared("debug_marker");
  auto params = rclcpp::Node::make_shared("debug_marker","~");
 rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr marker_pub_;

  marker_pub_ = nh_->create_publisher<visualization_msgs::msg::Marker>("/visualization_marker", 10);
  ...
  {
    RCLCPP_ERROR(nh_->get_logger(),"Failed to retrieve file: %s", e.what());
    return 1;
  }
