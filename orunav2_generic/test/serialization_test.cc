...
#include <orunav2_generic/io.hpp>
#include <fstream>
#include <iostream>
#include <ctime>
...
int main()
{
    ...
    {
        orunav2_generic::Control c1(0.1, 0.2);
        orunav2_generic::Control c2(0.3, 0.4);
        orunav2_generic::Pose2d p(1., 2., 3.);
        ...
        // Load
        orunav2_generic::Control c1_restored, c2_restored;
        orunav2_generic::Pose2d p_restored;
        {
    ...
    }
    {
        ...
        orunav2_generic::Path path = orunav2_generic::loadPathTextFile(txt_file_name.c_str());
        ...
        orunav2_generic::Pose2dVec pvec(path);
        {
        ...
        // Load
        orunav2_generic::Pose2dVec pvec_restored;
        {
        ...
        // Load
        orunav2_generic::Path path_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
    ...
    {
        orunav2_generic::CoordinatedTimes ct(10);
        ct[0] = 10.;
        ...
        // Load
        orunav2_generic::CoordinatedTimes ct_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
...

    {
        ...
        // Load
        orunav2_generic::Point2dVec pv_restored;
        {
            std::cout << " loading : " << file_name << std::endl;
            std::ifstream ifs(file_name.c_str());
            boost::archive::text_iarchive ar(ifs);
