/**
 * @file disc_world_visualizer.cpp
 * @author Paolo Forte
 * @brief 
 * @version 0.1
 * @date 2022-11-25
...
#include "orunav2_smac_planner/disc_world_visualizer.hpp"
...
void DiscWorldVisualizer::drawLHDConfiguration(LHDConfiguration* conf, int R, int G, int B) {
	...
	orunav2_smac_planner::LHDModel* model = dynamic_cast<orunav2_smac_planner::LHDModel*> (conf->getMission()->getVehicleModel());
	double scale = scaleFactor_ / WP::WORLD_SPACE_GRANULARITY;
