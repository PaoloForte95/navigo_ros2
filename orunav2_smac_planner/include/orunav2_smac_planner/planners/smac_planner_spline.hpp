...
#ifndef ORUNAV2_SMAC_PLANNER__SMAC_PLANNER_SPLINE_HPP_
#define ORUNAV2_SMAC_PLANNER__SMAC_PLANNER_SPLINE_HPP_
...
class SmacPlannerSpline : public nav2_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
  ...
  rclcpp::Logger _logger{rclcpp::get_logger("SmacPlannerSpline")};
...
#endif  // ORUNAV2_SMAC_PLANNER__SMAC_PLANNER_SPLINE_HPP_
