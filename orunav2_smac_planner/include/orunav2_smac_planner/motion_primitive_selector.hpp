/**
 * @file motion_primitive_selector
 * @author Paolo Forte
 *
 */

#ifndef MOTIONPRIMITIVESELECTOR_HPP_
#define MOTIONPRIMITIVESELECTOR_HPP_

// for the SuccessorGeneratorNode sorting
#include <algorithm>
#include <unordered_map>

#include "motion_primitive_data.hpp"
#include "utils.hpp"
...
#endif /* MOTIONPRIMITIVESELECTOR_HPP_ */
