...
#ifndef ORUNAV2_SMAC_PLANNER__SMOOTHER_HPP_
#define ORUNAV2_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @class orunav2_smac_planner::PathSegment
...
/**
 * @struct orunav2_smac_planner::BoundaryPoints
...
/**
 * @struct orunav2_smac_planner::BoundaryExpansion
...
/**
 * @class orunav2_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for orunav2_smac_planner::Smoother
   */
  explicit Smoother(const nav2_smac_planner::SmootherParams & params);

  /**
   * @brief A destructor for orunav2_smac_planner::Smoother
   */
  ~Smoother() {}
...
protected:
  ...
  nav2_smac_planner::MotionModel motion_model_;
  ompl::base::StateSpacePtr state_space_;
};

}  // namespace orunav2_smac_planner

#endif  // ORUNAV2_SMAC_PLANNER__SMOOTHER_HPP_
